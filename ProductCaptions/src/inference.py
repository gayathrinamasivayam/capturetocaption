...
class load_test:
    ...
    def __init__(self, filepath, imagetestfile):
        ...
        dir_pretrained = Path(os.getcwd()).parents[0]/"data"/"models"
        try:
            ...
            print("Error: {} Check if the pretrained model and the tokenizer exist in {}".format(errno.ENOENT, str(dir_pretrained)))
